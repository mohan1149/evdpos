...
const PaymentConfirmation = (props) => {
    ...
    const pay_item = props.route.params.item;
    const service = props.route.params.service[0];
    ...
    const executePayment = () => {
        ...
        axios({
            url: url,
            method: 'POST',
            data: "sid=" + service + "&amt=" + pay_item.Value[0] + "&chrg=0.0&lang="+lang+"&pid=" + pay_item.Id[0] + "&acc=&src=MP3&locMobNo="+props.route.params.inputs.mobile+"&objectid=&ctid=&pmtid=&contlist=&contamts=&cardnumber=&cmd=process&tlid=" + user.ID + "&trmId=" + user.src,
            headers: {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <ListItem bottomDivider>
                    <ListItem.Content>
                        <ListItem.Title>{pay_item.Value}</ListItem.Title>
